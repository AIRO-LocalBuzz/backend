...
class PostUseCaseTest {
    ...
    private CreatePostCommand createDraftCommand;
    private CreatePostCommand createPublishCommand;
    ...
    void setup() {
        ...
        createDraftCommand = CreatePostCommand.forDraft("테스트 제목", "테스트 내용", 1L);
        ...
        getPostQuery = GetPostQuery.of(1L);
    ...
    class CreatePostTest {
        ...
        void createDraftPost() {
            ...
            // when
            Post result = postUseCase.createPost(createDraftCommand);
        ...
        void createPublishedPost() {
            ...
            // when
            Post result = postUseCase.createPost(createPublishCommand);
        ...
        void createPostWithInvalidPublishCondition() {
            // given
            CreatePostCommand invalidCommand = new CreatePostCommand(
        ...
        void createPostWithImages() {
            ...
            CreatePostCommand commandWithImages = new CreatePostCommand(
            ...
            // when
            Post result = postUseCase.createPost(commandWithImages);
    ...
    class GetPostTest {
        ...
        void getPostById() {
            ...
            // when
            Post result = postUseCase.getPostById(getPostQuery);
        ...
        void getPostByIdNotFound() {
            ...
            // when & then
            assertThatThrownBy(() -> postUseCase.getPostById(getPostQuery))
        ...
        void getPostByIdWithViewCountIncrement() {
            // given
            GetPostQuery queryWithViewIncrement = GetPostQuery.byUser(1L, 2L);
            Post publishedPost = createTestPost(PostStatus.PUBLISHED);
            given(postRepository.findById(1L)).willReturn(publishedPost);
        ...
        void getPostWithDetails() {
            // given
            GetPostQuery detailQuery = GetPostQuery.withDetails(1L);
            Post publishedPost = createTestPost(PostStatus.PUBLISHED);
        ...
        void getPrivatePostByUnauthorizedUser() {
            ...
            GetPostQuery unauthorizedQuery = GetPostQuery.byUser(1L, 2L); // 다른 사용자
    ...
    class DeletePostTest {
        ...
        void deletePostByUnauthorizedUser() {
            ...
            // when & then
            assertThatThrownBy(() -> postUseCase.deletePost(unauthorizedCommand))
                    .isInstanceOf(PostAccessDeniedException.class);
        }
