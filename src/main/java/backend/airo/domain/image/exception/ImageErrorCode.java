...
public enum ImageErrorCode implements BaseErrorCode {
    ...
    // 400 에러들
    IMAGE_URL_REQUIRED(400, "IMAGE_001", "이미지 URL은 필수입니다"),
    ...
    IMAGE_ID_REQUIRED(400, "IMAGE_007", "이미지 ID는 필수입니다"),
    USER_ID_REQUIRED(400, "IMAGE_008", "사용자 ID는 필수입니다"),
    POST_ID_REQUIRED(400, "IMAGE_009", "게시물 ID는 필수입니다"),
